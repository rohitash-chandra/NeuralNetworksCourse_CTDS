...
class Network:
    ...
    def __init__(self, Topo, Train, Test, MaxTime, LearnRate, MinPer):
   	...
   	self.W1 = np.random.randn(self.Top[0]  , self.Top[1])
        ...
        print self.W1, 'W1 initialize'
        print self.B1, 'B1 initialize'
        self.BestB1 = self.B1
        self.BestW1 = self.W1
    	self.W2 = np.random.randn(self.Top[1] , self.Top[2])
        self.B2 = np.random.randn(self.Top[2])    # bias second layer
        print self.W2,  'W2 initialize'
        print self.B2,  'B2 initialize'
        self.BestB2 = self.B2
        self.BestW2 = self.W2
    ...
    def BackwardPass(self, input, desired ):
        ...
        print self.out_delta, '      out_delta'
        ...
        print self.hid_delta, '      hid_delta'
...
def main():
	...
	print 'printed data. now we use FNN for training ...'
        ...
        stocastic = 0 # 0 if vanilla (batch mode)
